...
@Named
public class Write2RecommendationToDB implements JavaDelegate {

    private final static Logger LOGGER = Logger.getLogger(Write2RecommendationToDB.class.getName());
