...
@Component
public class CamundaInitialDataGeneratorCreatCamundaUsers {


    private static final String ADMIN_USER = "admin";

    private static final Logger LOGGER = Logger.getLogger(CamundaInitialDataGeneratorCreatCamundaUsers.class.getName());

    private final ProcessEngine processEngine;

    @Autowired
    public CamundaInitialDataGeneratorCreatCamundaUsers(ProcessEngine processEngine) {
    ...
    public void createDemoUsers() {
        ...
        createGroup("Interviewers");

        identityService().createMembership("anna", "HR");
        identityService().createMembership("andrea", "Management");
        identityService().createMembership("candi", "Interviewers");
        identityService().createMembership("hans", "Interviewers");

        authorizeGroup("HR");
        authorizeGroup("Management");
        authorizeGroup("Interviewers");
